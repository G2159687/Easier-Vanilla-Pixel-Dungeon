 ...
 */
package com.epd.vanilla.actors.hero;
...
import com.epd.vanilla.Bones;
import com.epd.vanilla.Dungeon;
import com.epd.vanilla.GamesInProgress;
...
import com.epd.vanilla.actors.buffs.Combo;
import com.epd.vanilla.actors.buffs.Cripple;
import com.epd.vanilla.actors.buffs.Fury;
import com.epd.vanilla.actors.buffs.GasesImmunity;
...
import com.epd.vanilla.actors.buffs.Regeneration;
import com.epd.vanilla.actors.buffs.Roots;
import com.epd.vanilla.actors.buffs.Charm;
import com.epd.vanilla.actors.buffs.SnipersMark;
import com.epd.vanilla.actors.buffs.Vertigo;
...
import com.epd.vanilla.effects.CheckedCell;
import com.epd.vanilla.effects.Flare;
import com.epd.vanilla.effects.Speck;
import com.epd.vanilla.items.Amulet;
import com.epd.vanilla.items.Ankh;
import com.epd.vanilla.items.DewVial;
...
import com.epd.vanilla.items.KindOfWeapon;
import com.epd.vanilla.items.armor.Armor;
import com.epd.vanilla.items.keys.GoldenKey;
import com.epd.vanilla.items.keys.Key;
...
import com.epd.vanilla.items.rings.RingOfAccuracy;
import com.epd.vanilla.items.rings.RingOfDetection;
import com.epd.vanilla.items.rings.RingOfElements;
import com.epd.vanilla.items.rings.RingOfEvasion;
import com.epd.vanilla.items.rings.RingOfHaste;
import com.epd.vanilla.items.rings.RingOfShadows;
import com.epd.vanilla.items.rings.RingOfThorns;
...
import com.epd.vanilla.items.weapon.melee.MeleeWeapon;
...
import com.epd.vanilla.levels.features.AlchemyPot;
import com.epd.vanilla.levels.features.Chasm;
import com.epd.vanilla.levels.features.Sign;
...
import com.epd.vanilla.scenes.SurfaceScene;
import com.epd.vanilla.sprites.CharSprite;
import com.epd.vanilla.sprites.HeroSprite;
import com.epd.vanilla.ui.AttackIndicator;
...
public class Hero extends Char {
	...
	private int attackSkill =Dungeon.isChallenged( Challenges.HIGHSKILL ) ? 50: 10;
	private int defenseSkill = Dungeon.isChallenged( Challenges.HIGHSKILL ) ? 40 : 5;
	...
	public Hero() {
		...
		if (Dungeon.isChallenged(Challenges.MOREHP)){ HP = HT = 2000;
		} else { HP = HT = 20;}
		STR = STARTING_STR;
		awareness = 0.1f;
