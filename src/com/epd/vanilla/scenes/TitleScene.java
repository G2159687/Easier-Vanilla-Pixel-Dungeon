...
import com.epd.vanilla.effects.Fireball;
import com.epd.vanilla.ui.Archs;
import com.epd.vanilla.ui.ExitButton;
import com.epd.vanilla.ui.PrefsButton;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		BitmapText source = new BitmapText( "PD 1.9.1", font1x );
		source.measure();
		source.hardlight( 0x888888 );
		source.x = w - source.width();
		source.y = h - source.height();
		add( source );

		BitmapText ver = new BitmapText( "0.0.3", font1x );
		ver.measure();
		ver.hardlight( 0x888888 );
		ver.x = w - ver.width();
		ver.y = h - ver.height() - source.height();
		add( ver );
